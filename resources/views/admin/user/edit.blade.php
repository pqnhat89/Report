                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">Tên người
                                    dùng:</label>

                                <div class="col-md-6">
                                    <input class="form-control" name="name" value="{{ $user->name ?? null }}"
                                           required {{ ($user ?? null) ? 'disabled' : null }}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" name="email" value="{{ $user->email ?? null }}"
                                           required {{ ($user ?? null) ? 'disabled' : null }}>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">Nhập lại mật khẩu
                                    mới:</label>
                                    ...
                                    @foreach(\App\Enums\UserRole::toArray() as $role)
                                        <label>
                                            <input name="role" value="{{ $role }}"
                                                   type="radio" {{ ($user->role ?? null) == $role ? 'checked' : null }}> {{ \App\Enums\UserRole::getTitle($role) }}
                                        </label><br>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-md-4 col-form-label text-md-right">Trực thuộc
                                    Quận/Huyện:</label>
